...
// KHGravatar/AFNetworking
#define COCOAPODS_POD_AVAILABLE_KHGravatar_AFNetworking
#define COCOAPODS_VERSION_MAJOR_KHGravatar_AFNetworking 1
#define COCOAPODS_VERSION_MINOR_KHGravatar_AFNetworking 0
#define COCOAPODS_VERSION_PATCH_KHGravatar_AFNetworking 0

// KHGravatar/Core
#define COCOAPODS_POD_AVAILABLE_KHGravatar_Core
#define COCOAPODS_VERSION_MAJOR_KHGravatar_Core 1
#define COCOAPODS_VERSION_MINOR_KHGravatar_Core 0
#define COCOAPODS_VERSION_PATCH_KHGravatar_Core 0
